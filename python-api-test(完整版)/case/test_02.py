...
class Test_Kuaidi(unittest.TestCase):
    ...
    def setUp(self):
        self.headers = {
                  ...
                  # Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36   谷歌
    ...
    def chaxun_kuaidi(self, danhao, kd, kd_name):
        ...
        # http://www.kuaidi.com/index-ajaxselectcourierinfo-3381641350486-shentong.html  谷歌
